...
{
    /// <summary>
    /// Based on HashSet<T>, but optimized for small fixed size long set.
    ///
    ...
    /// 
    /// The capacity is fixed (see Size)
    /// 
    ...
    public class StopWordSet
    {
        ...
        public StopWordSet(IEnumerable<long> collection)
        {
            _lastIndex = 0;
            _count = 0;
            _freeList = -1;
        ...
        /// <summary>
        /// Checks if the stopwordset contains the item
        /// </summary>
